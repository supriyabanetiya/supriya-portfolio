...
const Header = () => {
  ...
  return (
    <header
      className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300 rounded-b-2xl max-w-sm md:max-w-5xl lg:max-w-screen-xl bg-white shadow-lg py-3`}
    >
      <nav className="container-custom px-4">
        <div className="flex items-center justify-between">
          <a
            href="#hero"
            className="text-2xl font-bold text-navy  transition-colors duration-300 mr-36 md:mr-96 sm:mr-48"
          >
